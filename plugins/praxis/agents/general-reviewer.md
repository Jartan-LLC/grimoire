...
3. **Index repeated comments** -- locate and run `find-duplicate-comments.js`, shipped under this plugin's `hooks/scripts/`; a retelling is invisible from the file it sits in.
